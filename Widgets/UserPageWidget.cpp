    ...
    ui(new Ui::UserPageWidget)
{
    ...
    // 布局
    this->layout()->setContentsMargins(SHADOW_PADDING, HEADER_HEIGHT + 40, SHADOW_PADDING, SHADOW_PADDING);

    // 窗口标题
    QLabel *lbHeader = new QLabel("书籍详情", ui->frameBackground);
    ...
    // 窗口的关闭按钮
    QPushButton * btnClose = new QPushButton("×", ui->frameBackground);
